                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-envelope"></i> jse.info@gmeil.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
...
<br><br>                        
                       ...
                       <p><code>Harga :</code> Rp. <?= $this->cart->format_number( $product->pro_price );  ?>  <code> Stock:</code> <?=  $product->pro_stock  ?> </p>
